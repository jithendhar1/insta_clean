								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-3">
										<div class="form-group">
											...
											<input type="text"  name="appointmentID"class="form-control"  id="appointmentID"/>
												...
												<tbody>
													...
													<tr>
														...
														<td style="text-align: right; padding-right: 30px; font-weight: bold; font-size: 16px;width: 230px">
															...
															<input name="totalamt" id="totalamt" class="form-control text-right" type="text" value="0" onblur="calculateAll()">
														</td>
													</tr>
												</tbody>
											</table>                               
