...
<form action="./RpSearchSrv" method="post">
        ...
        <table>
                ...
                int start = currentPage ;
                                ...
                                List<RolePermissionBean> leaves;
                              ...
                              //page
                                int recordcount= RPDAO.totalCount();
                               ...
                               //pagee
                                if (!whereClause.isEmpty()) {
                                    ...
                                    leaves = RPDAO.getFilteredRP("", start, limit);
                                }

                                for (RolePermissionBean leave : leaves) {
                %>
                <tr>
                   ...
                   <td><%=leave.getPermissionType()%></td>
                    ...
                    <td>
                        <a href="rolepermission_edit.jsp?RolePermissionID=<%= leave.getRolePermissionID() %>">Edit</a>
                    </td>
                    <td>
   ...
   <!-- Pagination links -->
    ...
    <% } %>
            ...
            <!-- Add Leave Modal -->
            <jsp:include page="rolepermission_add.jsp" />
